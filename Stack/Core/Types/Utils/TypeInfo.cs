...
namespace Opc.Ua
{
    ...
    public class TypeInfo : IFormattable
    {
        ...
        public static TypeInfo Unknown
        {
        ...
        public static TypeInfo Construct(Type systemType)
        {
            ...
            if (dimensions == null)
            {
                ...
                if (name.EndsWith("Collection", StringComparison.Ordinal))
                {
                    ...
                    if (systemType.BaseType.IsGenericType)
                    {
                        return Construct(systemType.BaseType);
                    }
                ...
                // check for encodeable object.
                if (typeof(IEncodeable).IsAssignableFrom(systemType) || name == "IEncodeable")
                {
            ...
            if (dimensions.Length == 2)
            {
                ...
                // check for encodeable object.
                if (typeof(IEncodeable).IsAssignableFrom(systemType.GetElementType()) || name == "IEncodeable")
                {
        ...
        {            
            ...
            switch (sourceType.BuiltInType)
            {
                ...
                case BuiltInType.String:
                {
                    ...
                    System.IO.MemoryStream ostrm = new System.IO.MemoryStream();
                    ...
                    for (int ii = 0; ii < text.Length; ii++)
                    {
                        ...
                        int index = digits.IndexOf(Char.ToUpper(text[ii], System.Globalization.CultureInfo.InvariantCulture));
