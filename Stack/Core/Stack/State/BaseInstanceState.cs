...
{       
    ...
    public abstract class BaseInstanceState : NodeState, IFilterTarget
    {
        ...
        public string GetDisplayPath(int maxLength, char seperator)
        {
            ...
            buffer.Append(GetNonNullText(parent));
            buffer.Append(seperator);
            buffer.Append(name);
