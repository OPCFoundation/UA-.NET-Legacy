...
namespace Opc.Ua.Bindings
{
    public class GenericAmqpListener : IAmqpListener, IDisposable
    {
        ...
        public async Task<IAmqpConnection> ConnectAsync(string amqpNodeName, bool useListenerCredentials)
        {
            ...
            if (connection == null)
            {
                ...
                if (useListenerCredentials || !m_settings.UseSasl)
                {
                ...
                connection = new GenericAmqpConnection(url.ToString(), AmqpNodeName, m_settings);
