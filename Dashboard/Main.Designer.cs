namespace WelcomeApplication
{
    partial class frmMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            WelcomeApplication.ApplicationState applicationState1 = new WelcomeApplication.ApplicationState();
            WelcomeApplication.ApplicationState applicationState2 = new WelcomeApplication.ApplicationState();
            WelcomeApplication.ApplicationState applicationState3 = new WelcomeApplication.ApplicationState();
            WelcomeApplication.ApplicationState applicationState4 = new WelcomeApplication.ApplicationState();
            WelcomeApplication.ApplicationState applicationState5 = new WelcomeApplication.ApplicationState();
            WelcomeApplication.ApplicationState applicationState6 = new WelcomeApplication.ApplicationState();
            WelcomeApplication.ApplicationState applicationState7 = new WelcomeApplication.ApplicationState();
            WelcomeApplication.ApplicationState applicationState8 = new WelcomeApplication.ApplicationState();
            WelcomeApplication.ApplicationState applicationState9 = new WelcomeApplication.ApplicationState();
            WelcomeApplication.ApplicationState applicationState10 = new WelcomeApplication.ApplicationState();
            WelcomeApplication.ApplicationState applicationState11 = new WelcomeApplication.ApplicationState();
            WelcomeApplication.ApplicationState applicationState12 = new WelcomeApplication.ApplicationState();
            WelcomeApplication.ApplicationState applicationState13 = new WelcomeApplication.ApplicationState();
            WelcomeApplication.ApplicationState applicationState14 = new WelcomeApplication.ApplicationState();
            ...
            this.lnkLaunchBrowser = new System.Windows.Forms.LinkLabel();
            ...
            this.toolTip1.SetToolTip(this.lnkOPCCertification, "Click to learn more about OPC Certification");
            this.lnkOPCCertification.LinkClicked += new System.Windows.Forms.LinkLabelLinkClickedEventHandler(this.lnkOPCCertification_LinkClicked);
            // 
            // lnkOpc
            // 
            ...
            this.pnlLeft.Controls.Add(this.appRefClient);
            this.pnlLeft.Controls.Add(this.appRefServer);
            this.pnlLeft.Controls.Add(this.appGnClient);
            this.pnlLeft.Controls.Add(this.appGnServer);
            this.pnlLeft.Controls.Add(this.appDiscoveryServer);
            this.pnlLeft.Controls.Add(this.label5);
            this.pnlLeft.Controls.Add(this.appACClient);
            this.pnlLeft.Controls.Add(this.appACServer);
            this.pnlLeft.Controls.Add(this.label4);
            this.pnlLeft.Controls.Add(this.appHEClient);
            this.pnlLeft.Controls.Add(this.appHEServer);
            this.pnlLeft.Controls.Add(this.appHAClient);
            this.pnlLeft.Controls.Add(this.appHAServer);
            this.pnlLeft.Controls.Add(this.label3);
            this.pnlLeft.Controls.Add(this.appDAClient);
            this.pnlLeft.Controls.Add(this.appDAServer);
    ...
    "r to consume data.";
            ...
            applicationState1.ProcessObject = null;
            applicationState1.State = false;
            this.appRefClient.AppState = applicationState1;
    ...
    "sting of the Unified Architecture";
            ...
            applicationState2.ProcessObject = null;
            applicationState2.State = false;
            this.appRefServer.AppState = applicationState2;
            ...
            // appGnClient
            // 
            this.appGnClient.ApplicationDescription = global::WelcomeApplication.Properties.Settings.Default.GenClientAppDescription;
            this.appGnClient.ApplicationName = global::WelcomeApplication.Properties.Settings.Default.GenClientAppName;
            applicationState3.ApplicationDescription = "UA Generic Client combines the features of several client profiles";
            applicationState3.ApplicationName = "Generic Client";
            applicationState3.ExeFilePath = "OPC.ua.sampleclient.exe";
            applicationState3.HelpFile = "webhelp\\ua_sample_client.htm";
            applicationState3.ProcessObject = null;
            applicationState3.State = false;
            this.appGnClient.AppState = applicationState3;
            ...
            // appGnServer
            // 
            this.appGnServer.ApplicationDescription = global::WelcomeApplication.Properties.Settings.Default.GenServerAppDescription;
            this.appGnServer.ApplicationName = global::WelcomeApplication.Properties.Settings.Default.GenServerAppName;
            applicationState4.ApplicationDescription = "UA Generic Server combines the features of several server profiles";
            applicationState4.ApplicationName = "Generic Server";
            applicationState4.ExeFilePath = "OPC.ua.sampleserver.exe";
            applicationState4.HelpFile = "webhelp\\ua_sample_server.htm";
            applicationState4.ProcessObject = null;
            applicationState4.State = false;
            this.appGnServer.AppState = applicationState4;
    ...
    "cation that queries it";
            ...
            applicationState5.ProcessObject = null;
            applicationState5.State = false;
            this.appDiscoveryServer.AppState = applicationState5;
    ...
    "arms & Conditions.";
            ...
            applicationState6.ProcessObject = null;
            applicationState6.State = false;
            this.appACClient.AppState = applicationState6;
    ...
    "events information to clients";
            ...
            applicationState7.ProcessObject = null;
            applicationState7.State = false;
            this.appACServer.AppState = applicationState7;
    ...
    "of Historical Events.";
            ...
            applicationState8.ProcessObject = null;
            applicationState8.State = false;
            this.appHEClient.AppState = applicationState8;
    ...
    "al events information to clients.";
            ...
            applicationState9.ProcessObject = null;
            applicationState9.State = false;
            this.appHEServer.AppState = applicationState9;
    ...
    "l Data.";
            ...
            applicationState10.ProcessObject = null;
            applicationState10.State = false;
            this.appHAClient.AppState = applicationState10;
    ...
    "/or dynamic historical data to clients.";
            ...
            applicationState11.ProcessObject = null;
            applicationState11.State = false;
            this.appHAServer.AppState = applicationState11;
    ...
    " and merely demonstrates the simple data-acquisition from an OPC UA DA Server.";
            ...
            applicationState12.ProcessObject = null;
            applicationState12.State = false;
            this.appDAClient.AppState = applicationState12;
    ...
    "riteble data.";
            ...
            applicationState13.ProcessObject = null;
            applicationState13.State = false;
            this.appDAServer.AppState = applicationState13;
    ...
    " trusts, and COM/UA interoperability.";
            ...
            applicationState14.ProcessObject = null;
            applicationState14.State = false;
            this.appUaConfigTool.AppState = applicationState14;
        ...
        private System.Windows.Forms.WebBrowser wbOPCFoundation;
        private System.Windows.Forms.LinkLabel lnkLaunchBrowser;
        private ApplicationUserControl appHEClient;
        private ApplicationUserControl appHEServer;
        private ApplicationUserControl appHAClient;
        private ApplicationUserControl appHAServer;
        private ApplicationUserControl appACClient;
        private ApplicationUserControl appACServer;
        private ApplicationUserControl appRefClient;
        private ApplicationUserControl appRefServer;
        private ApplicationUserControl appGnClient;
        private ApplicationUserControl appGnServer;
        private ApplicationUserControl appDAClient;
        private ApplicationUserControl appDAServer;
        private ApplicationUserControl appDiscoveryServer;
        ...
        private ApplicationUserControl appUaConfigTool;
